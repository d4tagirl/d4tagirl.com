...
description: How to palot animated maps in R, with gganimate and plotly.
---
...
I use the `maps` package to get the world map, using `ggplot2` and `theme_map` for plotting it in nicely.
