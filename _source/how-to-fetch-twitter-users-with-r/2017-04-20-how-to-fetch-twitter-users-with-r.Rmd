...
Now the dataframe is ready for me to use it for visualizing these Twitter users on a map (considering their sizes and dates of creation), and make some animations! If you are interested, you can check how I do it [here for using `plotly`]({% post_url 2017-04-26-how-to-deal-with-ggplotly-huge-maps %}){:target="_blank"} and [here for using `gganimate`]({% post_url 2017-04-24-how-to-plot-animated-maps-with-gganimate %}){:target="_blank"}. You can also go through mi [GitHub repo to see the code](https://github.com/d4tagirl/R-Ladies-growth-maps).
