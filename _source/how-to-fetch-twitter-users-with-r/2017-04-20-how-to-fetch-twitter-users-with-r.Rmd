...
users <- readRDS('/Users/Daniela/rladies_growing/users.rds')
```
...
```{r message = FALSE, warning = FALSE, screenshot.force = FALSE, fig.cap = ""}
library(knitr)
...
rladies <- readRDS('/Users/Daniela/rladies_growing/rladies_longlat.rds')

kable(head(rladies), format = "html")   

library(DT)
datatable(head(rladies))
```
