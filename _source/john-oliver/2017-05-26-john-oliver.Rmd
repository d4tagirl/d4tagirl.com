...
* `money`: `r emo::ji("moneybag")` what is wrong with this word?! Apparently is a very confusing one, because it is linked with _positive_ sentiment as _anticipation_, _joy_, _surprise_ and _trust_, but is also with _anger_. Anyway, this is a side comment because it's about the lexicon (_or the human nature!_) and not this analysis.
...
<div align="center"><img src="https://media.giphy.com/media/zZOJ2I4KiKaJ2/giphy.gif"/></div>
