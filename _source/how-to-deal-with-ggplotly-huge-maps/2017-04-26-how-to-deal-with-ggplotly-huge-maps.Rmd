...
This is the second one of the 3-posts-series, where I go from fetching Twitter users and preparing the data to visualizing it (If I wanted to show everything I've done in a single post, it would be almost as long as my first one! And I didn't want that `r emo::ji("stuck_out_tongue_closed_eyes")` ):
...
If you enjoyed this article, check out [the next one of the series here!]({% post_url 2017-04-24-how-to-plot-animated-maps-with-gganimate %}) or [the code in my GitHub repo](https://github.com/d4tagirl/R-Ladies-growth-maps). Thank you for reading `r emo::ji("wink")`
