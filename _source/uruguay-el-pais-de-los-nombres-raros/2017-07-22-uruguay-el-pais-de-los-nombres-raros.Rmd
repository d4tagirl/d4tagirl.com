...
---
A los uruguayos nos gusta inventar nombres raros... O al menos eso es lo que venimos escuchando hace años ya! Así que se me ocurrió analizar los nombres que los uruguayos hemos puesto a nuestros hijos desde 1940 hasta 2011 para ver qué encuentro. Un poco para apoyar la iniciativa de Datos Abiertos de [DATA](http://www.datauy.org/) y otro poco por mi propia curiosidad `r emo::ji("hugs")`  [Acá podés jugar con los datos en una Shiny app que hice](https://d4tagirl.shinyapps.io/uy_names/)!
...
Siempre se dijo que los uruguayos somos muy creativos para ponerle nombre a nuestros hijos (algo que llama mucho la atención sobre todo a los argentinos, como resaltan [en esta nota](https://www.pagina12.com.ar/diario/suplementos/radar/9-1233-2004-02-15.html)). Los criterios del Registro Civil para registrar los nombres de los nacidos no son muy estrictos, lo que deja mucho lugar a la discrecionalidad de los padres, así que cuando ví que el Registro Civil disponibilizó estos datos, algo tenía que hacer!
...
* `total_nombre`: el total de las personas registradas con ese nombre entre 1940 y 2011,
...
Arbitrariamente puse un límite de 200 personas con un nombre, y ahí me fijé los menos populares a ver qué tan exóticos son.
...
Para ver otros nombres (yo tengo muy mala memoria!) podés [jugar con esta Shiny app](https://d4tagirl.shinyapps.io/uy_names/). 

## Cada vez hay más nombres o es un mito?

Lo último que quiero ver es si nos hemos vuelto más creativos con los años. Para eso analizo la cantidad de nombres que hubo cada año, a ver si aumentó o disminuyó.
...
Aumentó de unos 1500 nombres en 1940 a unos 2000 en 2011, no parece tanto!