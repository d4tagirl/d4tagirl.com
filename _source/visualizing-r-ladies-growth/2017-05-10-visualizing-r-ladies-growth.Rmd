...
---
Here I show how I did this animation, from fetching R-Ladies' chapters' Twitter accounts, to plotting it using `plotly` and `gganimate`.

![](https://github.com/d4tagirl/d4tagirl.com/blob/rladies-map/figure/source/visualizing-r-ladies-growth/2017-05-10-visualizing-r-ladies-growth/rladies_chiquitito.gif)
...
I remove some frames from the beginning, because R-Ladies proliferated all over the globe in the past year or so but it took a long time from the creation of the first chapter until it started to get traction. The last part of the animation would be really fast in comparison ([you can check this animation in this post]({% post_url 2017-04-24-how-to-plot-animated-maps-with-gganimate %}){:target="_blank"}, so I take the _R-Ladies London_ creation as a breaking point, and before that date (2016-04-20) I only keep one frame every 6 months. It's a compromise I made: I sacrificed the accuracy of the time scale for the sake of a nicer visualization (and a reduction in the amount of frames!) `r emo::ji("woman_shrugging")`
...
Please leave your comments if you have any, or mention me on Twitter! Thanks for reading!
