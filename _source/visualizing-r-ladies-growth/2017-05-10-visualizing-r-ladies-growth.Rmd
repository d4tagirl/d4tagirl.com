...
---
Here I show how to go from fetching R-Ladies' chapters' Twitter accounts, to plotting them in a map using `plotly` and animating the map using `gganimate` to produce this .gif file.
