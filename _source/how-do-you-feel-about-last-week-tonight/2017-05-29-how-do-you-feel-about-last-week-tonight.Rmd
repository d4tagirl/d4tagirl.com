...
---
Here I analyze the text and sentiment behind the comments on the _Last week Tonight with John Oliver_ TV show's Youtube videos, and compare them with the Facebook ones.
...
Anyway, this 2 are side comments because they are about the lexicon (_or the human nature!_) and not this analysis. Bottom line: I don't like this lexicon `r emo::ji("unamused")`
...
Probably you were hoping for this! I couldn't pass up the opportunity to make a wordcloud `r emo::ji("tada")` Are those awesome or what?!
