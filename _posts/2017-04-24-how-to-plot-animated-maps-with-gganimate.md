...
I use the `maps` package to get the world map, using the `ggplot2::ggplot` and `ggthemes::theme_map` functions for plotting it nicely. And plot the chapters, choosing the purple color, obviously!
...
This animation is so cool! It shows how R-Ladies is spreading all over the globe, giving also some idea of how it is growing: where in the world it concentrates and how it accelerated its growing significantly in the last year or so!
<br />
