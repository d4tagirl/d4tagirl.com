...
summary: How I had to go from `gglotly` to `plotly::plot_geo` to reduce the size of the HTML output for posting interactive maps on my blog.
date: '2017-05-15T07:11:29'
tags:
  - rstats
  - r
  - plotly
  ...
  - maps
  - plot_geo
url: /2017/05/how-to-deal-with-ggplotly-huge-maps
rstats_feed: true
---
...
I'm using the [data produced in this previous post]({{< ref "post/2017-04-20-how-to-fetch-twitter-users-with-r" >}}). Let's take a look at it to see what we are dealing with.
...
<img src="/post/how-to-deal-with-ggplotly-huge-maps/2017-04-26-how-to-deal-with-ggplotly-huge-maps/static_map-1.png" style="margin: auto;" />
...
If you want to see this map [you can check it out here]({{< ref "post/2017-04-24-huge-ggplotly-map" >}}), but it will take a while! It is a 3.3 MB page (1.2 MB gzipped)!
...
And, if you enjoyed this article, check out [the next one of the series here!]({{< ref "post/2017-04-24-how-to-plot-animated-maps-with-gganimate" >}}) or [the code in my GitHub repo](https://github.com/d4tagirl/R-Ladies-growth-maps). Thank you for reading 😉
